...
public class DBUtil {
    ...
    private static void seedThemes(Connection conn) throws SQLException {
        seedTheme(conn, "zivotinje", "Životinje", new String[]{"MEDVED", "LISICA", "VRABAC", "ZMIJA", "JELEN", "ZEKO", "TIGAR", "ORAO", "RIBA", "VUKOVI", "KONJ", "BISON", "PTICA", "LASTA", "PANDA"});
    ...
    private static void seedAdminUser(Connection conn) {
        try (PreparedStatement updateExisting = conn.prepareStatement(
            ...
            // If the username is temporarily taken, the insert branch below will still keep existing data intact.
        }
